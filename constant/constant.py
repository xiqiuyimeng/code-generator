...
# 项目目录
PROJECT_PATH = (os.path.split(os.path.dirname(__file__))[0]).replace("\\", "/")
# 默认java模板文件路径
DEFAULT_JAVA_TP = '/template/java.txt'
# 默认mapper模板文件路径
DEFAULT_MAPPER_TP = '/template/mapper.txt'
# 默认xml模板文件路径
DEFAULT_XML_TP = '/template/xml.txt'
# 默认service模板文件路径
DEFAULT_SERVICE_TP = '/template/service.txt'
# 默认service_impl模板文件路径
DEFAULT_SERVICE_IMPL_TP = '/template/service_impl.txt'
# 默认controller模板文件路径
DEFAULT_CONTROLLER_TP = '/template/controller.txt'
# 默认java项目源码包的相对路径结构
