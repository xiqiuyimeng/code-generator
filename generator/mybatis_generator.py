...
from constant import mysql_type as mt
from constant.constant import DEFAULT_JAVA_TP, DEFAULT_MAPPER_TP, DEFAULT_XML_TP, \
    DEFAULT_PATH, DEFAULT_JAVA_SRC_RELATIVE_PATH, DEFAULT_MODEL_NS, DEFAULT_MAPPER_NS, \
    PARAM_PATH_ERROR, QUERY_SYS_TB, QUERY_TEMP_TB, CREATE_TEMP_TB, OUTPUT_PREFIX, PROJECT_PATH
