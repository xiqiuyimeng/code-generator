...
from constant.constant import ADD_CONN_MENU, GENERATE_MENU, FILE_MENU, HELP_MENU
...
def add_conn_menu(gui):
    ...
    :param gui: 启动的主窗口界面对象
    """
    add_action = QtWidgets.QAction(QtGui.QIcon(os.path.dirname(__file__) + '/../icon/add.jpg'), ADD_CONN_MENU, gui)
...
def exit_app_menu(gui):
    ...
    :param gui: 启动的主窗口界面对象
    """
    exit_action = QtWidgets.QAction(QtGui.QIcon(os.path.dirname(__file__) + '/../icon/exit.jpg'), '退出', gui)
...
def generate_menu(gui):
    ...
    :param gui: 启动的主窗口界面对象
    """
    generate_action = QtWidgets.QAction(QtGui.QIcon(os.path.dirname(__file__) + '/../icon/exec.jpg'), GENERATE_MENU, gui)
