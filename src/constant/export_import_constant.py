...
PROCESS_DUPLICATE_TEMPLATE_TITLE = '处理重复的类型映射数据'
PROCESS_ILLEGAL_TEMPLATE_TITLE = '处理异常的类型映射数据'
OVERRIDE_TEMPLATE_TITLE = '覆盖类型映射数据'
...
PROCESS_DUPLICATE_TEMPLATE_FUNC_TITLE = '处理重复的类型映射数据'
OVERRIDE_TEMPLATE_FUNC_TITLE = '覆盖类型映射数据'
