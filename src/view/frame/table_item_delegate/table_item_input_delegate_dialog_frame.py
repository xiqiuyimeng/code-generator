...
class TableItemInputDelegateDialogFrame(SaveDialogFrame):
    ...
    def check_text_available(self):
        if self.check_text_duplicate:
            text_available = check_text_available(self.text_editor.toPlainText(), self.unique_data_tuple,
    ...
    def set_unique_data_tuple(self, unique_data_tuple):
        self.unique_data_tuple = unique_data_tuple
