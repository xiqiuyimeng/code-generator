...
class TemplateMaintainFileConfigFrame(DialogFrameABC):
    ...
    def setup_content_ui(self):
        ...
        self.config_header_label = QLabel()
        self.config_header_label.setObjectName('maintain_config_tree_top_label')
        ...
        self.file_header_label = QLabel()
        self.file_header_label.setObjectName('maintain_config_list_top_label')
    ...
    def get_help_info_type(self) -> str:
        return TEMPLATE_FILE_OUTPUT_CONFIG_MAINTAIN_HELP
