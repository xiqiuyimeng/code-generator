# -*- coding: utf-8 -*-
from src.constant.generator_dialog_constant import BACK_TO_SELECT_TYPE_MAPPING_TXT, FILL_TEMPLATE_CONFIG_TXT
...
class SelectTemplateDialogFrame(SelectDialogFrame):
    ...
    def setup_other_label_text(self):
        ...
        self.next_frame_button.setText(FILL_TEMPLATE_CONFIG_TXT)
