...
from src.constant.ds_type_constant import (SQLITE_TYPE, SQLITE_DISPLAY_NAME, SQLITE_DB, SQLITE_TB, SQLITE_COL,
                                           MYSQL_TYPE, MYSQL_DISPLAY_NAME, MYSQL_DB, MYSQL_TB, MYSQL_COL, ORACLE_TYPE,
                                           ORACLE_DISPLAY_NAME, ORACLE_DB, ORACLE_TB, ORACLE_COL)
from src.constant.sql_constant import (SQLITE_QUERY_DB_SQL, SQLITE_QUERY_TB_SQL, SQLITE_QUERY_COL_SQL,
                                       MYSQL_QUERY_DB_SQL, MYSQL_QUERY_TB_SQL, MYSQL_QUERY_COL_SQL,
                                       ORACLE_QUERY_DB_SQL, ORACLE_QUERY_TB_SQL, ORACLE_QUERY_COL_SQL,
                                       SQLITE_CHECK_DB_SQL, SQLITE_CHECK_TB_SQL, MYSQL_CHECK_DB_SQL,
                                       MYSQL_CHECK_TB_SQL, ORACLE_CHECK_DB_SQL, ORACLE_CHECK_TB_SQL,
                                       MYSQL_QUERY_TB_COMMENT_SQL, ORACLE_QUERY_TB_COMMENT_SQL)
...
class ConnTypeEnum(Enum):
    ...
    oracle.query_tb_comment_sql = ORACLE_QUERY_TB_COMMENT_SQL
