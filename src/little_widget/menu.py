...
处理右键菜单
"""
from src.constant.constant import CLOSE_CONN_MENU, OPEN_CONN_MENU, TEST_CONN_MENU, ADD_CONN_MENU, EDIT_CONN_MENU, \
    DEL_CONN_MENU, CLOSE_DB_MENU, UNSELECT_TB_MENU, SELECT_ALL_TB_MENU, OPEN_DB_MENU, CLOSE_TABLE_MENU, \
    UNSELECT_FIELD_MENU, SELECT_ALL_FIELD_MENU, OPEN_TABLE_MENU
