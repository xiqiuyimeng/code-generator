...
from constant.constant import SPRING_TAB_TITLE, MYBATIS_TAB_TITLE
from generator.mybatis_generator import MybatisGenerator
from generator.spring_generator import SpringGenerator
