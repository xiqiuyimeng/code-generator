...
from func.connection_function import test_connection
from constant.constant import EDIT_CONN_MENU, ADD_CONN_MENU, \
    SAVE_CONN_SUCCESS_PROMPT, CONN_NAME_EXISTS
from settings.font import set_font, set_title_font
from little_widget.message_box import pop_ok, pop_fail
from sys_info_storage.sqlite import Connection, update_conn, \
...
class ConnDialog(QDialog):
    ...
    def setup_ui(self):
        ...
        palette.setBrush(self.backgroundRole(), QBrush(QPixmap(
            os.path.dirname(__file__) + '/../bg_jpg/dialog_bg.jpg'
        )))
